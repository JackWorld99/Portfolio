                    ...
                    <ul className="service-list">
                        <li className="service-item">
                            <div className="service-icon-box">
                                <Image src="/images/icon-design.svg" alt="design icon" width={40} />
                            </div>
                        ...
                        <li className="service-item">
                            <div className="service-icon-box">
                                <Image src="/images/icon-dev.svg" alt="Web development icon" width={40} />
                            </div>
                            <div className="service-content-box">
                        ...
                        <li className="service-item">
                            <div className="service-icon-box">
                                <Image src="/images/icon-app.svg" alt="mobile app icon" width={40} />
                            </div>
                            <div className="service-content-box">
                        ...
                        <li className="service-item">
                            <div className="service-icon-box">
                                <Image src="/images/icon-photo.svg" alt="camera icon" width={40} />
                            </div>
                            <div className="service-content-box">
                ...
                <section className="testimonials">
                    ...
                    <ul className="testimonials-list has-scrollbar">
                        <li className="testimonials-item">
                            <div className="content-card" data-testimonials-item>
                                <figure className="testimonials-avatar-box">
                                    <Image src="/images/avatar-1.png" alt="Daniel lewis" width={60} data-testimonials-avatar />
                                </figure>
                        ...
                        <li className="testimonials-item">
                            <div className="content-card" data-testimonials-item>
                                <figure className="testimonials-avatar-box">
                                    <Image src="/images/avatar-2.png" alt="Jessica miller" width={60} data-testimonials-avatar />
                                </figure>
                        ...
                        <li className="testimonials-item">
                            <div className="content-card" data-testimonials-item>
                                <figure className="testimonials-avatar-box">
                                    <Image src="/images/avatar-3.png" alt="Emily evans" width={60} data-testimonials-avatar />
                                </figure>
                        ...
                        <li className="testimonials-item">
                            <div className="content-card" data-testimonials-item>
                                <figure className="testimonials-avatar-box">
                                    <Image src="/images/avatar-4.png" alt="Henry william" width={60} data-testimonials-avatar />
                                </figure>
                    ...
                    <section className="testimonials-modal">
                        ...
                        <div className="modal-img-wrapper">
                            <figure className="modal-avatar-box">
                                <Image src="/images/avatar-1.png" alt="Daniel lewis" width={80} data-modal-img />
                            </figure>
